...
constructor(props) {
    ...
    this.handleSuccessfultResponse = this.handleSuccessfultResponse.bind(this)
    ...
    retriveWelcomeMessage() {
        ...
        // .then(response => this.handleSuccessfultResponse(response))
        // .catch()
    ...
    handleSuccessfultResponse(response) {
